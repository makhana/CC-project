...
public class CounterVisitor extends VisitorAdaptor {
	...
	public static class DesignatorUnpackingCounter extends CounterVisitor {
		...
		public void visit(DesignatorMul designatorMul) {
			...
			if (des instanceof DesignatorIdent) {
				objDesignatorMul = ((DesignatorIdent) des).obj;
			} else {
				objDesignatorMul = ((DesignatorNamespace) des).obj;
			}
		}
		...
		public void visit(DesignatorEq designatorEq) {
			...
			if (des instanceof DesignatorIdent) {
				objDesignatorEq = ((DesignatorIdent) des).obj;
			} else {
				objDesignatorEq = ((DesignatorNamespace) des).obj;
			}
		}
	}
}
